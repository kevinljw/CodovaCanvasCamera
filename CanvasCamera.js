...
CanvasCamera.prototype.createRenderer = (function (element, parent) {
    ...
    Renderer.prototype.draw = function(frame){
        if (frame) {
            ...
            // console.log(frame.sx, frame.sy, frame.sWidth, frame.sHeight, frame.dx, frame.dy, frame.dWidth, frame.dHeight);
            // this.context.beginPath();
            // this.context.arc(frame.sx, frame.sy, 70, 0, 2 * Math.PI, false);
